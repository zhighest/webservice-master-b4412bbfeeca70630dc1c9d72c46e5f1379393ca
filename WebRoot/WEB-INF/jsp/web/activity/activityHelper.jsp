...
<html>
  ...
  <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/web/classesList1.css?<%=request.getAttribute("version")%>"/>
  </head>
  <body class="fontFamily grayBkg">
  <div id="wrap"> 
      <div id="main">
        <c:set var="pageIndex" value="8"/>
        <div class="headerBox">
        ...
        <div class="width100"> 
          <div class="activityBanner positionR">
            <div class="wrapper positionR clearfix whiteTex">
              ...
              <div class="show2 positionA new">
                ...
                <p class="font18">Financial Classroom</p>
                <p class="font12">金融课堂</p>
              </div>
            </div>
          </div>
          <!-- banner end -->
          ...
          <div class="wrapper PT50">
            <p class="subTitle grayTex61">金融课堂</p>
            <p class="subDes grayTex61T">finsnvisl classroom</p> 
          </div>
  ...
  <script src="${pageContext.request.contextPath}/js/web/page/classesList1.js?<%=request.getAttribute("version")%>"></script>
  </body>
</html>