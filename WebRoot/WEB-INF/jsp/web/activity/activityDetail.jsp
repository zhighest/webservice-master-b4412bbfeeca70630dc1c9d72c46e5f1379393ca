...
<html>
  ...
  <body class="fontFamily">
    <div  id="mediaDetailP" class="headerBox1 none"></div>
  <div> 
      <div id="main">
        ...
        <div class="width100 headerBox"> 
          ...
          <div class="wrapper blockC clearfix">
            <div class="PT50">
                <div class="textC font24 clearfix headerBox">
                  <span class="blackTex" id="mediaTitle">标题</span>
                  <p class="grayTex99 font12" id="mediaTime">日期</p>
                  <div class="littleShortLine redBkg blockC"></div>
              </div>
              <div class="whiteBkg PTB20 MT30 MB30">
                <div class="width90 blockC grayTex61" id="mediaDetail"></div>
              </div>
            </div>
          </div>
      </div>
  ...
  <script src="${pageContext.request.contextPath}/js/web/page/activityDetail.js?<%=request.getAttribute("version")%>"></script>
  </body>
</html>
