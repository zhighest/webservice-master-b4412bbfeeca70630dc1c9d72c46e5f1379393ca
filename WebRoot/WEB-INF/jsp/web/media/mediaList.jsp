  <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <p class="subTitle grayTex61">媒体报道</p>
    <p class="subDes grayTex61T">Media reports</p>
    </div>
    <div class="PB50">
    ...
    <script src="${pageContext.request.contextPath}/js/web/page/mediaList.js?<%=request.getAttribute("version")%>"></script>
    </body>
    </html>