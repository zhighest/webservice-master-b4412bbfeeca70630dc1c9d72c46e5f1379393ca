...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/web/voucher.css?<%=request.getAttribute("version")%>"/>
  ...
  <body class="fontFamily">
  			...
  			<div class="contentWrapper positionR">
  				...
  				<div class="clearfix grayBkgf5 width100 PTB30">
					<div class="wrapper clearfix">
  						<c:set var="sidebarIndex" value="8"/>
  						<%@  include file="../sidebar.jsp"%>
  						<div class="fr font12 blackTex">当前位置：<a class="blackTex" href="${pageContext.request.contextPath}/trade/goAccoutOverview">个人中心 / </a><span class="redTex">代金券</span></div>
  					</div>
  				</div>
  				...
  				<div class="clearfix witeBkg width100 PTB30">
  					<div class="wrapper textL fon20 positionR">
  						...
  						<p class="grayTex61 lineHeight100">代金券</p>
  						<p class="grayTex61 opacity60">Voucher</p>
						<!-- 代金券筛选按钮 -->
	...
	<script src="${pageContext.request.contextPath}/js/web/page/voucher.js?<%=request.getAttribute("version")%>"></script>
  </body>
</html>
