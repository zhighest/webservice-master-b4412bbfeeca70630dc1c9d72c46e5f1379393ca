				...
				<div class="contentWrapper positionR">
					...
					<div class="wrapper">
						<div class="clearfix PTB30">
							<c:set var="helpSidebar" value="10" />
					...
					<div class="helpCenterBanner banner1">
						<div class="wrapper">
							<div class="MT180">
								<p class="subTitle whiteTex show1">签到</p>
								<p class="subDes whiteTex show5">Sign in</p>
							</div>
						</div>
					</div>
					...
					<div class="ActiveProductDetail " id="product2">
						<ul class="clearfix PT20">
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第一步：<span class="font12 Color2c fontWeightIntial">点击每日加息</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/SignInImg1.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第二步：<span class="font12 Color2c fontWeightIntial">点击签到</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/SignInImg2.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第三步：<span class="font12 Color2c fontWeightIntial">签到成功</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/SignInImg3.png">
							</li>
						</ul>
					</div>
				</div>
