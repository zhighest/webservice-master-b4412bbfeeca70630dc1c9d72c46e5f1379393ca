			...
			<div id="main">
				...
				<div class="contentWrapper positionR">
					...
					<div class="helpCenterBanner banner1">
						<div class="wrapper">
							<div class="MT180">
								<p class="subTitle whiteTex show1">购买定期</p>
								<p class="subDes whiteTex show5">Investment term asset </p>
							</div>
						</div>
					</div>
					...
					<div class="ActiveProductDetail " id="product2">
						<ul class="clearfix PT20">
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第一步：<span class="font12 Color2c fontWeightIntial">点击定期投资</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/fixProductImg1.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第二步：<span class="font12 Color2c fontWeightIntial">选择投资标的</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/fixProductImg2.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第三步：<span class="font12 Color2c fontWeightIntial">点击立即投资</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/fixProductImg3.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第四步：<span class="font12 Color2c fontWeightIntial">输入投资金额</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/fixProductImg4.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第五步：<span class="font12 Color2c fontWeightIntial">输入交易密码</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/fixProductImg5.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第六步：<span class="font12 Color2c fontWeightIntial">查看投资订单</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/fixProductImg6.png">
							</li>
							<li class="clearfix marginLeft0Im">
								<p class="Color4a font20 fontBold MB10 ">第七步：<span class="font12 Color2c fontWeightIntial">查看订单详情</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/fixProductImg7.png">
							</li>
						</ul>
					</div>
