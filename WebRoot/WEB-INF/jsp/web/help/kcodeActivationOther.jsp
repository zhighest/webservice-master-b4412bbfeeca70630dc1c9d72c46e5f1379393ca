		...
		<div id="wrap">
			<div id="main">
				...
				<div class="contentWrapper positionR">
					...
					<!--其他产品-->
					<div class="ActiveProductDetail " id="product6">
						<p class="font20 MB30">其他产品 <span class="font12 Color97"></span></p>
						<ul class="clearfix">
							<li class="clearfix">
						...
						<div class="textL ActiveProductS7 width100 MT20">
							...
							<p class="MB10 font12 Color9c">2、老用户激活K码产品需使用相对应的K码券方可激活。</p>
							...
							<p class="MB10 font12 Color9c">5、激活K码产品前须实名认证。</p>
