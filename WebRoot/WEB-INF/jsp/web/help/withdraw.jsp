			...
			<div id="main">
				...
				<div class="contentWrapper positionR">
					...
					<div class="helpCenterBanner banner1">
						<div class="wrapper">
							<div class="MT180">
								<p class="subTitle whiteTex show1">提现</p>
								<p class="subDes whiteTex show5">Withdraw</p>
							</div>
						</div>
					</div>
					...
					<div class="ActiveProductDetail " id="product2">
						<ul class="clearfix PT20">
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第一步：<span class="font12 Color2c fontWeightIntial">点击提现</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/withdrawImg1.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第二步：<span class="font12 Color2c fontWeightIntial">输入提现金额</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/withdrawImg2.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第三步：<span class="font12 Color2c fontWeightIntial">确认提示信息</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/withdrawImg3.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第四步：<span class="font12 Color2c fontWeightIntial">输入交易密码</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/withdrawImg4.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第五步：<span class="font12 Color2c fontWeightIntial">提现申请成功</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/withdrawImg5.png">
							</li>
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第六步：<span class="font12 Color2c fontWeightIntial">查看提现中的金额</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/withdrawImg6.png">
							</li>
						</ul>
					</div>
