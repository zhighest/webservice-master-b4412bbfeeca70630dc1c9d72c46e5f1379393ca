		...
		<div id="wrap">
			<div id="main">
				...
				<div class="contentWrapper positionR">
					...
					<!--斐讯智能路由器K2P-->
					<div class="ActiveProductDetail" id="product3">
						<p class="font20 MB30">斐讯智能路由器K2P <span class="font12 Color97">含K1,K1S,K2C</span></p>
						<ul class="clearfix">
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第一步：<span class="font12 Color2c fontWeightIntial">刮开产品获得底部k码</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/KcodeActivationImg1-3.jpg">
							</li>
							<li class="clearfix">
						...
						<div class="textL ActiveProductS7 width100 MT20">
							...
							<p class="MB10 font12 Color9c">2、老用户激活路由器k2P需使用相对应的K码券方可激活。</p>
							...
							<p class="MB10 font12 Color9c"> 5、激活K2p前须实名认证。</p>
