			...
			<div id="main">
				...
				<div class="contentWrapper positionR">
					...
					<div class="ActiveProductDetail " id="product2">
						<p class="font20 MB30">斐讯双频无线路由器K3 <span class="font12 Color97"></span></p>
						<ul class="clearfix">
							<li class="clearfix">
								<p class="Color4a font20 fontBold MB10">第一步：<span class="font12 Color2c fontWeightIntial">刮开产品获得底部k码</span></p>
								<img src="${pageContext.request.contextPath}/pic/web/help/KcodeActivationImg1-2.jpg">
							</li>
							<li class="clearfix">
						...
						<div class="textL ActiveProductS7 width100 MT20">
							...
							<p class="MB10 font12 Color9c">2、新老用户首次激活k3，均可无条件激活1台K3，后续需使用K3的K码券才可再次激活。</p>
							...
							<p class="MB10 font12 Color9c"> 5、激活K3前须实名认证。</p>
