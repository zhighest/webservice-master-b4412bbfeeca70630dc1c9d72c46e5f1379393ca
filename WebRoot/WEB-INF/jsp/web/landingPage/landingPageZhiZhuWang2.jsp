...
<head>
  ...
  <body class="grayBkg01">
    ...
    <div class="banner positionR">
         <div class="positionA landingBkgImg" id="banner">
             <img  src="${pageContext.request.contextPath}/pic/web/landingPageWeb/banner.jpg?<%=request.getAttribute("version")%>">
         </div>
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/web/page/landingPageZhizhuwang2.js?<%=request.getAttribute("version")%>"></script>
</html>
