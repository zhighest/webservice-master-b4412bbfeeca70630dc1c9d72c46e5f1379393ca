...
<head>
  ...
  <body class="whiteBkg">
    ...
    <div class="banner">
        <div class="bannerCotent positionR blockC">
            <img class="positionA landingImg" src="${pageContext.request.contextPath}/pic/web/landingPage/landingImg1.png" height="480px">
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/web/page/landingPage1.js?<%=request.getAttribute("version")%>"></script>
</html>
