...
<head>
  ...
  <body class="whiteBkg">
    ...
    <div class="redBkg textL PT60 PB40">
        <div class="width60 MLRA lineHeight2x whiteTex newwidth">
            ...
            <p class="strong">5、本活动最终解释权归联璧金融所有。</p>
        </div>
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/web/page/landingPageWozhushou.js?<%=request.getAttribute("version")%>"></script>
