...
<head>
  ...
  <body class="grayBkg01">
    ...
    <div class="banner positionR">
         <div class="positionA landingBkgImg" id="banner">
             <img  src="${pageContext.request.contextPath}/pic/web/landingPageWeb/zhizhuwangWebBanner1.jpg?<%=request.getAttribute("version")%>">
         </div>
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/web/page/landingPageZhizhuwang.js?<%=request.getAttribute("version")%>"></script>
</html>
