...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/web/landingPageWeb.css?<%=request.getAttribute("version")%>" />
  ...
  <body class="grayBkg01">
    <div class="whiteBkg" id="header">
        <div class="header clearfix PT20 PB15 blockC">
            ...
            <div class="fr PT10">
                <a class="grayTex99" href="${pageContext.request.contextPath}/webindex/goIndex">进入联璧官网</a>
            </div>
        </div>
    </div>
    <div class="banner positionR">
         <div class="positionA landingBkgImg" id="banner">
             <img id="bannerImg" src="${webPicLink}">
         </div>
                ...
                <div class="PB20">
                    ...
                    <div class="PLR15">
                        ...
                        <div class="positionR MT20">
                            ...
                            <input onkeyup="$.checkLimit1($(this),'',false);" type="password" class="inputNoborder bkgNone radius10 PL40 PTB5 width230 height30" name="loginPassword" id="loginPassword" value="" maxlength="16" placeholder="密码由8-16个字符(字母数字或符号)"/>
                        </div>
                        <!-- 图形验证码 -->
                        ...
                        <div class="positionR MT20 clearfix">
                            ...
                            <input id="checkCode" maxlength="6" name="checkCode" value="${userDto.checkCode}" class="inputNoborder PL40 radius10 PTB5 fl bkgNone width120 height30" placeholder="手机验证码" oninput="$.checkLimit($(this),'',false);" onkeyup="$.checkLimit($(this),'',false);" onafterpaste="$.checkLimit($(this),'',false);"/>
                        ...
                        <p class="textL PL30 whiteTex  blockC grayTexf5 font12 MT20 positionR">
        ...
        <div class="PT40  advantageWrap blockC">
            ...
            <ul class="advantageList clearfix MT50 whiteTex">
                <li class="fl">
                    ...
                    <p class=" font18 MT10 lineHeight2x grayTex99">8%活期理财 资金快速提现</p>
                </li>
                <li class="fl">
                    ...
                    <p class=" font18 MT10 lineHeight2x grayTex99">100元起投 人人轻松理财</p>
                </li>
                <li class="fl">
                    ...
                    <p class=" font18 MT10 lineHeight2x grayTex99">供应链资产 实力平台担保</p>
                </li>
                <li class="fl">
                    ...
                    <p class=" font18 MT10 lineHeight2x grayTex99">资金托管 1亿元实缴资金</p>
                </li>
            </ul>
          </div>
        </div>
    ...
    <!-- 活动规则 -->
     ...
     <h2 class="activityTitle font30 strong whiteTex">活 动 规 则</h2>
        <ul class="activityRules  textL " id="activityRules">
        </ul>
    ...
    <div class="choose">
        ...
        <h3 class="font14 blackTex1 strong MT20">严格筛选优质资产为投资理财人士提供安全、高收益的理财产品 </h3>
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/web/page/landingPageWeb.js?<%=request.getAttribute("version")%>"></script>
</html>
