...
<body class="whiteBkg">
	...
	<input id="loanId" name="loanId" type="hidden" value="<%=request.getParameter("loanId")%>">
	<!-- <input id="productType" name="productType" type="hidden" value="${productType}"> -->
	<script src="${pageContext.request.contextPath}/js/weixin/page/enjoyTodayUserInfoList.js?<%=request.getAttribute("version")%>"></script>
