...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/weixin/loginQiCheDaShi.css?<%=request.getAttribute("version")%>" />
    <%@  include file="../header.jsp"%>
</head>
<body class="positionR">
	<div class="wrapper">
		<div class="imgDiv clearfix">
			<img src="${pageContext.request.contextPath}/pic/weixin/landingPageTemplate/qichedashiBanner.jpg?<%=request.getAttribute("version")%>">
		</div>
		<!-- 活动详情开始 -->
	    ...
	    <div class="positionF activityDetailBkg  none">
	    	...
	    	<div class="activityTxt positionA">
	    	 <ul>
         		  <li>1、新用户注册即送1%加息券，免费送162元现金红包。</li>
			      <li>2、注册下载联璧金融app后，加息券和现金红包可以直接在个人账户里查看。</li>
			      <li>3、162元现金红包（2元活期代金券、定期10元、定期50元和定期100元），投资时可以直接抵用提现。</li>
			      <li>4、本活动是联璧金融活动，与苹果公司无关，若发现恶意注册行为，有权取消相关奖励。</li>
			      <li>5、有任何问题可以咨询联璧金融客服热线：<span class="JsPhoneCall"></span>或关注微信联璧钱包</li>
             </ul>
	    	</div>
 	    </div>
	    <!-- 活动详情结束 -->
...
<!-- 				</form> -->
	...
	<script src="${pageContext.request.contextPath}/js/weixin/page/landingPage/loginQiCheDaShi.js?<%=request.getAttribute("version")%>"></script>
