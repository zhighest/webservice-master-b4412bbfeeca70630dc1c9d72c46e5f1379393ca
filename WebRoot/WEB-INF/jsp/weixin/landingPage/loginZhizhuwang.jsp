...
<body class="positionR">
	<div class="wrapper">
		<div class="imgDiv clearfix">
			<img src="${pageContext.request.contextPath}/pic/weixin/landingPageTemplate/ZhiZhuWang.jpg?<%=request.getAttribute("version")%>">
		</div>
		<!-- 活动详情开始 -->
	    ...
	    <div class="positionF activityDetailBkg  none">
	    	...
	    	<div class="activityTxt positionA">
	    	 <ul>
			      ...
			      <li>2、注册联璧金融并成功首次投资铃铛宝定期（3月期或6月期）800元，即送星际迷航3电影票1张，首投2000元（含）以上即送星际迷航3电影票2张；</li>
			      <li>3、投资成功后，电影票通兑码将在1个工作日内通过客服确认后以短信形式发送；</li>
...
<!-- 				</form> -->
	...
	<script src="${pageContext.request.contextPath}/js/weixin/page/landingPage/loginZhiZhuWang.js?<%=request.getAttribute("version")%>"></script>
