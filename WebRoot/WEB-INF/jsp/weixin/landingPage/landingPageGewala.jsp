...
<body class="positionR">
	<div class="wrapper">
		<div class="imgDiv clearfix">
			<img src="${pageContext.request.contextPath}/pic/weixin/landingPageTemplate/gewalaWxBanner.jpg?<%=request.getAttribute("version")%>">
		</div>
		<!-- 活动详情开始 -->
...
<!-- 				<form id="loginForm"> -->
					<div class="MT30">
						...
						<div class="positionR whiteBkg MB10 radius5">
							...
							<div class="ML50"><input type="" name="phoneNum" id="phoneNum" value="${userDto.phoneNum}" maxlength="11" oninput="$.checkLimit($(this),'',true);" onkeyup="$.checkLimit($(this),'',true);" onafterpaste="$.checkLimit($(this),'',true);" placeholder="请输入手机号" class="inputBkg1  width90 whiteBkg" />
							</div>
						</div>
						<!-- 登录密码-->
						<div class="positionR whiteBkg MB10 radius5 ">
...
<!-- 				</form> -->
	...
	<script src="${pageContext.request.contextPath}/js/weixin/page/landingPage/loginGewala.js?<%=request.getAttribute("version")%>"></script>
