...
<body class="positionR">
	<div class="wrapper">
		<div class="imgDiv clearfix">
			<img src="${pageContext.request.contextPath}/pic/weixin/landingPage/img_01.jpg?<%=request.getAttribute("version")%>">
		</div>
		<div class="imgDiv clearfix">
			<img src="${pageContext.request.contextPath}/pic/weixin/landingPage/img_02.jpg?<%=request.getAttribute("version")%>">
		</div>
...
<!-- 				<form id="loginForm"> -->
					<div class="MT30">
                        ...
                        <!-- <div class="positionR whiteBkg MB10 radius5">
							<span class="positionA inputIcon ML10"><img src="${pageContext.request.contextPath}/pic/weixin/landingPageTemplate/icon-02.png?<%=request.getAttribute("version")%>" width="30"></span>
							<div class="ML50"><input type="password" placeholder="请再次输入交易密码确认" maxlength="16" class="inputBkg1  width100" id="passWord"/>
							</div>
						</div> -->
						<!-- 图片验证码 -->
...
<!-- 				</form> -->
	...
	<div class="btmAreaFix clearfix" id="btmAreaFix">
	  	...
	  	<div class="rightArea textL">
		  	<h4>联璧金融</h4>
		  	<p>使用APP客户端，体验更多惊喜！</p>
		  	<a href="http://a.app.qq.com/o/simple.jsp?pkgname=com.lincomb.licai" class="btmFixBtn" rel="nofollow">下载APP</a>
	  	</div>
  	</div>
	...
	<script src="${pageContext.request.contextPath}/js/weixin/page/landingPage/loginLiuliangbao.js?<%=request.getAttribute("version")%>"></script>
