...
<body class="positionR">
	<div class="wrapper">
		<div class="imgDiv clearfix">
			<img src="${pageContext.request.contextPath}/pic/weixin/landingPageTemplate/zhizhuwangWxBanner1.jpg?<%=request.getAttribute("version")%>">
		</div>
<!-- 活动详情开始 -->
	    ...
	    <div class="positionF activityDetailBkg  none">
	    	...
	    	<div class="activityTxt positionA">
	    	 <ul>
			      ...
			      <li>2、注册联璧金融并成功首次投资铃铛宝定期（3月期或6月期）1000元，即送电影票1张，首投2000元（含）以上即送电影票2张，首投5000（含）以上即可获得6张；</li>
			      <li>3、投资成功后，电影票通兑码将在1个工作日内通过客服确认后以短信形式发送，节假日延后工作日发放。</li>
...
<!-- 				</form> -->
	...
	<script src="${pageContext.request.contextPath}/js/weixin/page/landingPage/loginLiuliangbaoZhizhuwang.js?<%=request.getAttribute("version")%>"></script>
