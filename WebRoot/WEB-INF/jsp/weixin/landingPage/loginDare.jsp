...
<body class="positionR">
	<div class="wrapper">
		...
		<div class="imgDiv clearfix">
			<img src="${pageContext.request.contextPath}/pic/weixin/landingPage/img_03.jpg?<%=request.getAttribute("version")%>">
		</div>
	<!-- 活动详情开始 -->
...
<!-- 				</form> -->
	...
	<script src="${pageContext.request.contextPath}/js/weixin/page/landingPage/loginDare.js?<%=request.getAttribute("version")%>"></script>
