...
<body class="positionR">
	<div class="wrapper">
		<div class="imgDiv clearfix">
			<img src="${pageContext.request.contextPath}/pic/weixin/wojiatisu/img_01.jpg?<%=request.getAttribute("version")%>">
		</div>
		<div class="imgDiv clearfix">
			<img src="${pageContext.request.contextPath}/pic/weixin/wojiatisu/img_02.jpg?<%=request.getAttribute("version")%>">
		</div>
			<!-- 活动详情开始 -->
...
<!-- 				</form> -->
	...
	<script src="${pageContext.request.contextPath}/js/weixin/page/landingPage/loginWozhushou.js?<%=request.getAttribute("version")%>"></script>
