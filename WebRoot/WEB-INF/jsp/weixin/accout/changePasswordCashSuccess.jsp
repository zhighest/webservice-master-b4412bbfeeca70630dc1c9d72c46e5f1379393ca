...
<body>
	<div class="PT40P">
		...
		<p class="font16 grayTex MT20">修改密码成功！</p>
	</div>
	<div class="width80 blockC MT30"><a class="btn width100 block font18 radius5" href="${pageContext.request.contextPath}/wxtrade/goMyAsset">确定</a></div>
