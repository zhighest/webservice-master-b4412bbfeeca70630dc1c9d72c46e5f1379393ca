...
$("#loginSubmit").click(function(){
  if(!goLoginBtn){
    ...
    goLoginBtn = false;
    ajaxRequest(contextPath + "/wxlanding/register", "phoneNum=" + phoneNum + "&channel=zhizhuwang&verifycode="+verifycode+"&captcha="+checkCode+"&isLogin=Y"+"&password="+loginPassword, setLogin);
});
//点击图片验证码
