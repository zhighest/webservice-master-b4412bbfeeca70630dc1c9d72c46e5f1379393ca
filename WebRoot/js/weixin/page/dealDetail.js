var host = "",
	...
	function list(data) {
		...
		else if(obj.isShowTurnOut == "1"|| obj.isShowTurnOut ==1){
			html += '<li class=" clearfix PB20"><span class="fl">申请时间</span><span class="fr grayTex">' + obj.applyTime + '</span></li>';
		}
		if(obj.isShowTurnOut == "1"|| obj.isShowTurnOut ==1){
			if(obj.tradeTime==""){
				html += '<li class=" clearfix PB20"><span class="fl">交易时间</span><span class="fr grayTex">-</span></li>';
			}
			else{
				html += '<li class=" clearfix PB20"><span class="fl">交易时间</span><span class="fr grayTex">' + obj.tradeTime + '</span></li>';
			}
		}
		else{
			if(obj.transDate==""){
		...
		if(obj.isShowTurnOut == "1" || obj.isShowTurnOut ==1 || obj.fundType=="普通提现"){
			html += '<li class=" clearfix PB20"><span class="fl">手续费(元)</span><span class="fr grayTex">' + obj.feeAmount  + '</span></li>';
		}
