...
*/
	...
	ajaxRequest(contextPath + "/wxlanding/register", "phoneNum=" + phoneNum + "&channel=liuliangbao&passwordCash="+ traderPassword+ "&verifycode="+verifycode+"&captcha="+checkCode+"&password="+password, getRegister);
});
var InterValObj;
