...
*/
	...
	ajaxRequest(contextPath + "/wxlanding/register", "phoneNum=" + phoneNum + "&channel=wozhushou&passwordCash="+ traderPassword+ "&verifycode="+verifycode+"&captcha="+checkCode+"&password="+password, getRegister);
});
var InterValObj;
