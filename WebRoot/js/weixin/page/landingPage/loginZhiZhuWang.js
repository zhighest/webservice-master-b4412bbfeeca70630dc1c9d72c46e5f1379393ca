...
$("#loginSubmit").click(function() {
   ...
   if(password == '' || password == null){
    ...
    ajaxRequest(contextPath + "/wxlanding/register", "phoneNum=" + phoneNum + "&channel=zhizhuwang2&verifycode="+verifycode+"&captcha="+checkCode+"&password="+password, getRegister);
});
var InterValObj;
