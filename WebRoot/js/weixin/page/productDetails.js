...
var finishedRatio;
//var finishedRatio = $("#finishedRatio").val();  //投资进度
var goOrderConfirmation = function(loanId, planId, sloanId, earnings, inputAmount,cpType,rateIds,rateRises,voucherAmount,voucherId,finishedRatio) {
...
$("#enterBid").on("click",function(){
	  goOrderConfirmation(loanId,planId,sloanId,earnings,inputAmount,cpType,rateIds,rateRises,voucherAmount,voucherId,finishedRatio);  
})
//是否有加息劵，是否使用
...
var setOrderFormDetails = function(data) {
    finishedRatio = data.list[0].finishedRatio;
...
$(document).ready(function() {
    ...
    ajaxRequest(contextPath + "wxtrade/getRiskEvaluationById", "mobile="+mobile,setRiskEvaluationById,"GET");//判断是否风险评估
});
